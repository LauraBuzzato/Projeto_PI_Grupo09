...
function buscarDadosPedido(idVeiculo) {
    var instrucao = `
        select c.nome, c.cnpj, concat(e.logradouro,', ', e.numero), p.data_entrega_prevista, p.tipo_medicamento1, p.quantidade_medicamento1, 
        p.tipo_medicamento2, p.quantidade_medicamento2, p.idpedido, v.tipo from cliente c
