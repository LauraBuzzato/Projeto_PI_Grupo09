...
function cadastrar(nome,CNPJ,telefone,logradouro, cep, estado, cidade, bairro, numero, complemento) {
    ...
    var instrucaoSql = `
        INSERT INTO endereco (logradouro, cep, estado, cidade, bairro, numero, complemento) VALUES 
        ('${logradouro}', '${cep}', '${estado}', '${cidade}', ${bairro}', '${numero}', '${complemento}');
